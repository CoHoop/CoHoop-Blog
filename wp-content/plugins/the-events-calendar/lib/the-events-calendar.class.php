...
if ( !class_exists( 'TribeEvents' ) ) {
	...
	class TribeEvents {
		...
		public function loadStyle() {
			...
			wp_enqueue_script('tribe-events-pjax', $eventsURL.'jquery.pjax.js', array('jquery'), true );
			wp_enqueue_script('tribe-events-calendar-script', $eventsURL.'events.js', array('jquery', 'tribe-events-pjax'), true );
