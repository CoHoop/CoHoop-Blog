...
<head>
	...
	<!--<link rel="stylesheet" href="<?php /*bloginfo('stylesheet_directory'); ?>/css/shadowbox.css" type="text/css" media="screen" />
...
<div id="header">
    ...
    <?php if(ide_option('nav')):
            if(function_exists('wp_nav_menu')) wp_nav_menu( array( 'menu_class' => 'nav', 'theme_location' => 'menu_main' ) );
        endif; ?>
    </div>
</div><!-- header //-->
